    ...
    private fun populateData() {
        ...
        _foodList.value?.run {
            ...
            add(Food("recipe_corn_fritters", "Corn fritters",
                ...
                15,
                10,
                listOf(Ingredient("Frozen sweet corn kernels", "1.5 cups"), Ingredient("Spring onions – with green tops, sliced", "4 onions"), Ingredient("Capsicum – seeds removed - chopped", "1 small"),
                    Ingredient("Parsley or chives – chopped", "1/4 cup"),
                    ...
                    Ingredient("Wholemeal self-raising flour", "1 cup"),
                    Ingredient("Canola oil for cooking", "1 tbsp") ),
            ...
            add(Food("recipe_quick_creamy_porridge", "Quick, creamy porridge",
                ...
                5,
                15,
                listOf(Ingredient("Quick-cooking oats", "3 cups"),
                    Ingredient("Water", "3 cups"),
                    Ingredient("Milk – any milk of your choice", "4 cups")),
            ...
            add(Food("recipe_banana_piklet",
                ...
                listOf(Ingredient("Bananas, peeled, mashed – see Quick tip below", "2"),
                    ...
                    Ingredient ("Wholemeal self-raising flour", "2 1/3 cups"),
            ...
            add(Food("recipe_tomato_red_lentil_and_vegetable_soup",
                ...
                listOf(Ingredient("Olive oil", "1 tbsp"),
                    Ingredient("Onions, chopped", "1"),
                    Ingredient("Split red lentils", "3/4 cup"),
                    Ingredient("Boiling water", "2.5 cups"),
                    Ingredient("Jap pumpkin, peeled and chopped", "200g"),
                    Ingredient ("Salt reduced tomato paste sauce", "2.5 cups"),
            ...
            add(Food("recipe_baked_meatballs",
                ...
                listOf(Ingredient("Lean minced beef", "600 g"),
                    ...
                    Ingredient("Sweet chilli sauce", "1 tbsp"),
                    Ingredient("Dried breadcrumbs", "2 cups"),
            ...
            add(Food("recipe_carrot_and_sultana_muffins",
                ...
                "These are really moist and fruity muffins, and this recipe is suitable for involving children!",
                ...
                listOf(Ingredient("Canola oil, plus extra for greasing", "1/4 cup"),
                    ...
                    Ingredient("Honey", "1/4 cup"),
                    Ingredient("Brown sugar", "1/4 cup"),
                    Ingredient("Eggs, beaten", "2"),
                    Ingredient("Sultanas", "1/3 cup"),
                    Ingredient("Milk – any milk of your choice", "1/4 cup"),
                    Ingredient("White self-raising flour", "1 cup"),
                    Ingredient ("Wholemeal self-raising flour", "3/4 cup"),
